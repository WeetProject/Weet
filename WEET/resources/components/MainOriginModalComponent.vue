    ...
    <div class="main_modal_container">
        <div class="main_modal_search_article">
            ...
            <div class="main_modal_search_section" :class="{ query_focus: isQueryFocus }">
                ...
                name="origin_input" id="origin_input" v-model="originQuery"
                autocomplete="off" spellcheck="false" placeholder="국가, 도시명 검색"
                maxlength="15" @input="originInput" @focus="originFocus" @blur="originBlur">
            ...
            <div class="main_modal_suggetion_section" v-if="originQuery && originQuerySuggestion.length >= 1 && originFlg">
                <div class="main_modal_suggetion_area">
                    <div class="main_modal_suggetion_list" 
                        ...
                        :key="originSuggestion.id"
                        @click="originSuggestionData(originSuggestion)">
                        <div class="main_modal_suggetion_list_city_country">
                            ...
                            <span class="main_modal_suggetion_list_city_country_span">
                                {{ originSuggestion.airport_kr_city_name }},
                                {{ originSuggestion.airport_kr_country_name }} 
                                {{ originSuggestion.airport_city_name }}
                            </span>
                        </div>
                        <div class="main_modal_suggetion_list_iatacode_airport">
                            ...
                            <span class="main_modal_suggetion_list_iatacode_airport_span">
                                {{ originSuggestion.airport_iata_code }} | 
                                {{ originSuggestion.airport_kr_name }}
                            </span>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    created() {
        this.debounceAlgoliaOriginQuery = debounce(this.algoliaOriginQuery, 200);  
    },
    ...
    methods: {
        ...
        originSuggestionData(originSuggestion) {
            this.$emit('originExchangeQueryData', originSuggestion);
        },
