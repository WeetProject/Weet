		...
		<div class="admin_login_section">
			<div class="admin_login_left_section">
				<div class="admin_login_title_section">
					...
					<p class="text-2xl font-black admin_login_title">Admin</p>
				</div>
				<form class="admin_login_form" action="" method="post"></form>
					<!-- <label class="font-semibold admin_login_label">ID</label> -->
					<div class="admin_login_input_area">
						...
						<input class="text-base admin_login_input" type="text" name="admin_id" id="admin_id" placeholder="Enter your ID">
					</div>
					<!-- <label class="font-semibold admin_login_label">PASSWORD</label> -->
					<div class="admin_login_input_area">
						<svg class="admin_login_input_svg" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
							<path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z" />
						</svg>
						<input class="text-base admin_login_input" type="password" name="admin_password" id="admin_password" placeholder="Enter your Password">
					</div>
