        ...
        <div class="mypage_box1">
            ...
            <div class="mypage_menu">
                <div class="mypage_menu_button">
                    <div class="mypage_menu_button_content">
                        <!-- 여행객 아이콘 -->
                    ...
                    <div class="mypage_menu_button_content_btn">
                        <!-- 화살표버튼 -->
